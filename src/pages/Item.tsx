...
const Item = () => {
  ...
  return (
    <Container>
      ...
      {administratorItems?.data.items && administratorItems?.data.items.length > 0 ? 
              ...
              actions={
                item.durability ? (
                  <div style={durabilityStyles}>
                    <p style={{marginRight: "10px"}}>Durabilité: {item.durability}</p>
                    <p>Jours utilisé: {item.daysInUse}</p>
                  </div>
                ) : (
                  <div style={durabilityStyles}>
                    <p style={{marginRight: "10px"}}>Charges: {item.charges}</p>
